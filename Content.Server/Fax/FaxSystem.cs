        ...
        if (args.Data.TryGetValue(DeviceNetworkConstants.Command, out string? command))
        {
            switch (command)
            {
                ...
                case FaxConstants.FaxPrintCommand:
                    ...
                    var printout = new FaxPrintout(content, name, label, prototypeId, stampState, stampedBy, locked ?? false, senderFaxName, stampProtected ?? false, blueprintRecipes); // Frontier: add stampProtected, blueprintRecipes
